...
<div class="widget-box">
		...
		<div class="widget-header brown">
		    <h4 class="span8"><i class="icon-dollar"></i> Royalty Distribution</h4>
		</div>
		<div>
...
?>
	<iframe src="hc_royalty_distribution_frame.php" width="100%" height="600" frameborder="0" scrolling="yes"></iframe>
<?
}
?>
