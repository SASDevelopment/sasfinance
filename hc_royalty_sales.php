...
$use_xp_db='sasroyalties';
//$use_xp_db='xulonpress';

if ($_REQUEST['GETPID']) { 
	$GETPID=$_REQUEST['GETPID'];
} else {
	$GETPID='77427';
}
...
$HC_ENTITY_ID=$_REQUEST['HC_ENTITY_ID'];
echo "<p><a href='https://www.xulonauthors.com/_test/sasfinance/side_by_side_dist.php?GETCID=$GETCID&HC_ENTITY_ID=$HC_ENTITY_ID' target='_blank'>View Distribution Report</a></p>";
...
display_acc_info($_REQUEST['GETPID']);
...
<form method='GET' action='<?=$_SERVER['PHP_SELF']?>'>
        ...
        <select id="end_year_val" name="end_year_val">
			...
			<input type='hidden' name='GETPID' value='<?=$_REQUEST['GETPID']?>'>
			<input type='hidden' name='HC_BOOK_ID' value='<?=$_REQUEST['HC_BOOK_ID']?>'>
