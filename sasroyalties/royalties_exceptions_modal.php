        ...
        do {
            ...
            if($myrows["id"] == $edit) {
                ...
                $tablerows .= "
                        <td>" . $projectid . "</td>
                        <td>" . $Contact_ID . "</td>
                        <td><input size='15' autofocus id='Royalty_ISBN_" . $count . "' type='text' style='border:1px solid #ff0000' name='Royalty_ISBN' value='".$myrows["Royalty_ISBN"]."'></td>
                        <td>" . $ORG_TITLE . "</td>
                        <td>" . $ORG_AUTHOR . "</td>
                        <td>" . $Royalty_Month . "</td>
                        <td>" . $Royalty_Source . "</td>
                        ";
                if($sold == 1) { $tablerows .= "<td>" . $Royalty_Books_Returned . "</td>"; } else { $tablerows .= "<td width='75'><input size='10' id='Royalty_Books_Sold_" . $count . "' type='text' style='border:1px solid #ff0000' name='Royalty_Books_Sold' value='".$myrows["Royalty_Books_Sold"]."'></td>"; }
                if($returns == 1) { $tablerows .= "<td>" . $Royalty_Books_Returned . "</td>"; } else { $tablerows .= "<td width='75'><input size='10' id='Royalty_Books_Returned_" . $count . "' type='text' style='border:1px solid #ff0000' name='Royalty_Books_Returned' value='".$myrows["Royalty_Books_Returned"]."'></td>"; }
                $tablerows .= "
                        <td width='75'>$<input size='7' id='Royalty_Amount_" . $count . "' type='text' style='border:1px solid #ff0000' name='Royalty_Amount' value='".$myrows["Royalty_Amount"]."'></td>
                        ...
                        <td>
                            <input type='image' name='Submit' id='Submit' value='Save' src='/sasfinance/images/save.png' style='vertical-align:middle; height:18; width:18;'/>
                            &nbsp;
                            <a href='".$_SERVER['PHP_SELF']."' title='Cancel' onclick='javascript:urlredirect(management.referral_codes.php);'><img valign='middle' src='/sasfinance/images/cancel.png' height='18' width='18'></img></a>
                        </td>
                    </tr>
                </form>
                ";
            ...
            else
            {
                ...
                $tablerows .= "
                    <tr id='tr_" . $count . "' $rowcolor>
                        ...
                        <td>$fgcolor$ORG_TITLE</td>
                        <td>$fgcolor$ORG_AUTHOR</td>
                ...
                if(isset($add) == '' && isset($edit) == 0) {
                    ...
                    $tablerows .= "
                                &nbsp;&nbsp;&nbsp;&nbsp;
                                <a href='".$_SERVER['PHP_SELF']."?edit=".$myrows['id']."' value=".$myrows['id']." title='Edit' name=".$myrows["$Royalty_ISBN"]." id=edit_".$myrows['id']." onclick='javascript:popup(this.id)'><img valign='middle' src='/sasfinance/images/pencil.png' height='14' width='14'></img></a>
                                <!--a href='".$_SERVER['PHP_SELF']."?delete=".$myrows['id']."' value=".$delete_values." title='Delete' name=".$myrows['$Royalty_ISBN']." id='Delete' class='confirmDelete'><img valign='top' src='/sasfinance/images/delete.gif'></img></a-->
                            ";
                }
...
<script type="text/javascript">
    ...
    $(".btn1").click(function(){
        ...
        $.ajax({
            type: "GET",
            url: '/sasfinance/sasroyalties/royalties_exceptions_reprocess.php',
            data: { "reprocess":1 },
